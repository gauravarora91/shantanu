...
<div class="header" width="100%" style="background-color:black; height:100px;">
  <img src="resources/rutogo.png" alt="Creating Email Magic" width="155px" height="92px" style="display: block; float:left; padding: 4px 0px 4px 13px;" />
          <p align="right" style="color:white;  margin: 0; padding: 8px 17px 4px 0px;font-family:Trebuchet MS,Arial,Helvetica,sans-serif;">Invoice No : <?php echo $invoice_no; ?></p>
          <p align="right" style="color:white; margin: 0; padding: 0px 17px 4px 0px;font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><?php echo $invoice_date; ?> </p>
</div>
       ...
       <tr>
         <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
           <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
             <td>
              <h1 align="left" style="margin:0;font-family:Trebuchet MS,Arial,Helvetica,sans-serif;">Hi <?php echo $name; ?></h1>
            ...
            <td align="left" style="padding: 5px 0 5px 0; float:left;">
               <h1 style="font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><?php echo $pickup_location; ?></h1>
               <p style="font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><b><?php echo $pickup_date ?></b></p> 
             </td>
            ...
            <td align="center" style="padding: 20px 0 5px 0;   float: left; margin-left: 23%;">
               ...
               <p style="font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><b><?php echo $car_type.", ".$car_name; ?></b></p> 
             </td>


            <td align="right" style="padding: 5px 0 5px 0; float:right;">
               <h1 style="font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><?php echo "$drop_location"; ?></h1>
               <p style="font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><b><?php echo "$drop_date"; ?></b></p> 
             </td> 
             ...
             <tr>
             <td align="center" style="padding: 5px 0 5px 0;">
               <p style="font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><b>You rode with <?php echo $operator_details; ?></b></p>
...
<![endif]-->
            ...
            <tr>
             <td style="">
               ...
               <p  style="float:right;font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><b><?php echo $billed_km; ?></b></p> 
             </td>
            </tr>
            ...
            <tr>
             <td style="">
               ...
               <p  style="float:right;font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><b><?php echo $no_of_days; ?></b></p> 
             </td>
            </tr>
            ...
            <tr>
             <td style="">
               ...
               <p  style="float:right;font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><b>Rs <?php echo $fare_per_km; ?></b></p> 
             </td>
            </tr>
            ...
            <tr>
             <td style="">
               ...
               <p  style="float:right;font-family:Trebuchet MS,Arial,Helvetica,sans-serif;"><b>Rs <?php echo $da; ?></b></p> 
             </td>
            </tr>
